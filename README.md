...
[![Tests Passing](https://img.shields.io/badge/pytest-64%20passed-success.svg?logo=pytest&logoColor=white)](#-automated-testing--verification)
...
Run the comprehensive 64-test automated suite covering intent classification, FAISS vector retrieval, risk gating, multilingual translation, and VAPT security:
...
├── tests/                         # 64 automated pytest tests across 12 modules
